      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        <div className="mt-6 flex items-center justify-between rounded-2xl border border-white/10 bg-black/30 p-3 backdrop-blur-xl">
          <a href="#" className="flex items-center gap-2 text-white">
            ...
            <span className="font-semibold">PetSales Foundation</span>
          </a>
          ...
          <button className="rounded-xl border border-white/20 bg-white/10 px-3 py-2 text-white backdrop-blur hover:bg-white/20 md:hidden">
            <Menu size={18} />
          </button>
        </div>
      </div>
