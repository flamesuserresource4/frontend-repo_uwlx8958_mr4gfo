  ...
  return (
    <section className="relative min-h-[90vh] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 pt-28 pb-24 text-center text-white sm:px-8 lg:px-12">
        ...
        >
          Responsible Pet Foundation • Pet Sales with Purpose
        </motion.span>
        ...
        >
          Where every adoption funds care, training, and a forever home
        </motion.h1>
        ...
        >
          Discover ethically sourced pets, transparent care records, and a community-first marketplace.
        </motion.p>
        ...
        >
          <a href="#catalog" className="rounded-xl bg-white px-6 py-3 text-slate-900 shadow-lg shadow-white/20 transition hover:-translate-y-0.5 hover:shadow-xl">
            Browse Pets
          </a>
          <a href="#mission" className="rounded-xl border border-white/30 bg-white/10 px-6 py-3 backdrop-blur-md transition hover:bg-white/20">
            Our Mission
          </a>
        </motion.div>
      </div>
